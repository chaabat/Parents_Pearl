...
import { debounceTime, distinctUntilChanged, take, map, takeUntil, finalize, catchError } from "rxjs/operators"
          ...
          if (this.parentId) {
            this.parentService
              ...
              .pipe(
                ...
                catchError((err) => {
                  this.searchError = "Error searching tasks. Please try again."
